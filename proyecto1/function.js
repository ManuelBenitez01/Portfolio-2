...
let clientevip = document.getElementById("clientevip");
let cliente = document.getElementById("cliente");
let gasto = document.getElementById("gasto");
let descuento = document.getElementById("descuento");
let total = document.getElementById("total");

let tipoCliente = prompt("Tipo de cliente:");
//let gastoCliente = parseInt(prompt("Gasto del cliente:"));

 
if (tipoCliente === "vip") {
    clientevip.innerHTML = "El cliente es VIP";
    cliente.innerHTML = ""; 
} else if (tipoCliente === "regular") {
    cliente.innerHTML = "El cliente es Regular";
    clientevip.innerHTML = ""; 
} else {
    cliente.innerHTML = "Categoría no reconocida";
    clientevip.innerHTML = "";
}
if  (tipoCliente === "vip"){
    let gastoCliente = parseInt(prompt("Gasto del cliente:"));
    if (gastoCliente <= 100) {
        ...
        total.innerHTML = "Total a pagar: " + (gastoCliente - (gastoCliente * 0.10));
    } else if (gastoCliente >= 100){
        descuento.innerHTML = "Descuento del 20%";
        total.innerHTML = "Total a pagar: " + (gastoCliente - (gastoCliente * 0.20));
    }
}else if (tipoCliente === "regular"){
    let gastoCliente = parseInt(prompt("Gasto del cliente:"));
    if (gastoCliente <= 50) {
        descuento.innerHTML = "No Tiene Descuento";
        total.innerHTML = "Total a pagar: " + gastoCliente;
    } else if (gastoCliente >= 50 && gastoCliente <= 100){
        descuento.innerHTML = "Descuento del 5%";
        total.innerHTML = "Total a pagar: " + (gastoCliente - (gastoCliente * 0.05));
    } else if (gastoCliente >= 100){
        descuento.innerHTML = "Descuento del 10%";
        total.innerHTML = "Total a pagar: " + (gastoCliente - (gastoCliente * 0.10));
    }
